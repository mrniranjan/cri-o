...
const (
	...
	// ParentPodUIDAnnotation specifies the UID of the parent pod. When set, the pod will be created
	// as a sub-pod under the parent pod's cgroup hierarchy.
	ParentPodUIDAnnotation = "io.kubernetes.cri-o.ParentPodUID"
